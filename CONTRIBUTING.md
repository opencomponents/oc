...
When preparing a pull request, ensure all the tests pass locally running `grunt test`. If you have admin rights, do it on a new branch on the upstream opentable repo. This allows all the test to run smoothly.
