...
let fsMock, packageTemplate, uglifySpy;
  ...
  describe("when packaging component's template", () => {
      ...
      describe('when component view type is not valid', () => {
        ...
        it('should show error', () => {
          expect(error).to.equal(
            'template.wha compilation failed - Error requiring oc-template: "whazaaa-compiler" not found'
          );
        });
      });
    });
    ...
    describe('when component is valid', () => {
      ...
      it('should save compiled view', () => {
        expect(fsMock.writeFile.args[0][1]).to.contain(
          '<div>this is a jade view</div>'
        );
      });
    });
  });
...
//       xit('should save compiled view', () => {
//         expect(fsMock.writeFile.args[0][1]).to.contain('<div>this is a jade view</div>');
//       });
//     });
//   });
// });
>>>>>>> muted tests that need to be moved or being reworked couse of the unified compiler API
