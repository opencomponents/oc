...
//       xit('should not get an error', () => {
//         expect(error).to.be.null;
//       });

//       xit('should copy the file in the folder', () => {
//         expect(mocks['fs-extra'].copySync.calledOnce).to.be.true;
//       });

//       xit('should copy the file to the right destination', () => {
...
//       xit('should copy the files to the folder', () => {
//         expect(mocks['fs-extra'].copySync.calledTwice).to.be.true;
//       });

//       xit('should copy the files to the right destinations', () => {
//         expect(mocks['fs-extra'].copySync.args[0][1]).to.equal('/path/to/component/_package/img/file.png');
...
//         xit('should first transpile and minify the file', () => {
...
//         xit('should first minify the file', () => {
//           expect(mocks['fs-extra'].readFileSync.calledOnce).to.be.true;
