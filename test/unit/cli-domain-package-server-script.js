...
//     xit('should return an array containing a function and a regular expression ', () => {
...
//       xit('should match npm module names', () => {
...
//       });
//       xit('should not match local modules', () => {
...
//       xit('should return an error if a specific npm-module is missing from the given dependencies', (done) => {
...
//         });
//       });
//       xit('should invoke the callback with no arguments if module is not missing from the given dependencies', (done) => {
...
//       xit('should return a proper configuration options for webpack', () => {
