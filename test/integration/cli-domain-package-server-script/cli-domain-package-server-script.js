...
//       xit('should throw an error with error details', (done) => {
//         try {
//           packageServerScript(
//             {
...
//       xit('should save compiled data provider and return a hash for the script', (done) => {
//         packageServerScript(
//           {
//             componentPath: componentPath,
//             ocOptions: {
...
//       xit('should save compiled data provider encapsulating json content', (done) => {
//         packageServerScript(
//           {
//             componentPath: componentPath,
//             ocOptions: {
...
//       xit('should save compiled data provider', (done) => {
...
//         xit('should throw an error with details', (done) => {
...
//       xit('should save compiled data provider encapsulating js module content', (done) => {
//         packageServerScript(
//           {
//             componentPath: componentPath,
//             ocOptions: {
...
//       xit('should transpile it to es2015 through Babel', (done) => {
//         packageServerScript(
//           {
//             componentPath: componentPath,
//             ocOptions: {
...
//       xit('should wrap while/do/for;; loops with an iterator limit', (done) => {
//         packageServerScript(
//           {
//             componentPath: componentPath,
//             ocOptions: {
...
//             xit('should save compiled data provider', () => {
//               expect(error).to.be.null;
//             });

//             xit('save compiled data provide should work as expected', () => {
...
//             xit('should wrap while/do/for;; loops with an iterator limit', () => {
