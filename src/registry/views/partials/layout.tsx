  ...
  return (
    <Fragment>
      ...
      <html lang="en">
        ...
        <body>
          <a href={href}>
            <img src={imgSrc} alt="OpenComponents Registry" />
          </a>
